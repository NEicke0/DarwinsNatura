package com.DarwinsNatura.common.blocks.item;
        ...
        else
        {
            if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
            {
                ...
                if (iblockstate.getMaterial() == Material.WATER && ((Integer)iblockstate.getValue(BlockLiquid.LEVEL)).intValue() == 0 && worldIn.isAirBlock(blockpos1))
                {
                    ...
                    worldIn.setBlockState(blockpos1, DarwinsNaturaBlocks.LILLY_PAD.getDefaultState());
                    ...
                    worldIn.setBlockState(blockpos1, DarwinsNaturaBlocks.LILLY_PAD.getDefaultState(), 11);
