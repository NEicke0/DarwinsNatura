...
public class ModelGalapagosPenguin extends AdvancedModelBase {
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
		...
		swing(Body1, 0.1f * globalSpeed, 0.1f * globalDegree, false, 0f, 0f, f, f1);
		//flap(Body1, 0.1f * globalSpeed, 0.065f * globalDegree, false, 0f, 0f, f, f1);
		...
		walk(RightLeg2, 0.1f * globalSpeed, 0.15f * globalDegree, false, 2f, -0.1f, f ,f1);
		walk(LeftLeg2, 0.1f * globalSpeed, 0.15f * globalDegree, true, 2f, -0.1f, f ,f1);
		walk(Head, 0.07f * globalSpeed, 0.09f * globalDegree, true, 0f, 0f, f, f1);
		walk(Neck1, 0.07f * globalSpeed, 0.09f * globalDegree, false, 0f, -0.5f, f, f1);
		...
		walk(Belly2, 0.06f * globalSpeed, 0.05f * globalDegree, true, 0f, 0f, f, f1);
