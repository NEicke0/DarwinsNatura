package com.DarwinsNatura.common.entities.aquatic.reptile;
...
public abstract class EntityAquaticReptileBase extends EntityGender{
	
    private static final DataParameter<Boolean> MOVING = EntityDataManager.<Boolean>createKey(EntityAquaticReptileBase.class, DataSerializers.BOOLEAN);
    private EntityLivingBase targetedEntity;
    private int clientSideAttackTime;
    private boolean clientSideTouchedGround;
    protected EntityAIWander wander;
    private EntityAquaticReptileBase.GuardianMoveHelper moveHelpCross = new EntityAquaticReptileBase.GuardianMoveHelper(this);
    private EntityMoveHelper helpMove = new EntityMoveHelper(this);;

    public EntityAquaticReptileBase(World worldIn)
    {
        super(worldIn);
    ...
    static class GuardianMoveHelper extends EntityMoveHelper
        {
            private final EntityAquaticReptileBase entityGuardian;

            public GuardianMoveHelper(EntityAquaticReptileBase Swimmer)
            {
                super(Swimmer);
