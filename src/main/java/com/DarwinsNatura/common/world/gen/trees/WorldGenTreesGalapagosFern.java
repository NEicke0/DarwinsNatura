...
public class WorldGenTreesGalapagosFern extends WorldGenAbstractTree
{
    private static final IBlockState LOG = DarwinsNaturaBlocks.GALAPAGOS_FERN_TREE_PART.getDefaultState();
    private static final IBlockState LEAF = Blocks.AIR.getDefaultState();
    private final boolean useExtraRandomHeight;

    public WorldGenTreesGalapagosFern(boolean notify, boolean useExtraRandomHeightIn)
    {
        super(notify);
