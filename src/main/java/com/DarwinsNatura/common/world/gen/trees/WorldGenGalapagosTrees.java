...
//    private IBlockState blockStateWood = DarwinsNaturaBlock.galapagos_log.getDefaultState();
//    private IBlockState blockStateLeaves = DarwinsNaturaBlock.galapagos_leaves.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

    private final int minTreeHeight = 6;

    public WorldGenGalapagosTrees(boolean parShouldNotify)
    {
