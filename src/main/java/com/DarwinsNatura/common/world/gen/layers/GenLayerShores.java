...
public class GenLayerShores extends GenLayer {
	public GenLayerShores(long p_i2130_1_, GenLayer p_i2130_3_) {
		super(p_i2130_1_);
	 ...
	 * interpreted as temperatures, rainfall amounts, or Biome ID's based on the
