package com.DarwinsNatura.common.world.gen.trees;
...
public class WorldGenTreesScalesia extends WorldGenAbstractTree
{
    private IBlockState blockStateWood = DarwinsNaturaBlocks.SCALESIA_LOG.getDefaultState();
    private IBlockState blockStateLeaves = DarwinsNaturaBlocks.SCALESIA_LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

    private final int minTreeHeight = 8;

    public WorldGenTreesScalesia(boolean parShouldNotify)
    {
