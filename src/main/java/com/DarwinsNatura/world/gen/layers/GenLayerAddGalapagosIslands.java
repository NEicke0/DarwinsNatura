...
public class GenLayerAddGalapagosIslands extends GenLayer
{
    public GenLayerAddGalapagosIslands(long p_i2120_1_, GenLayer p_i2120_3_)
    {
        super(p_i2120_1_);
    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
    {
        ...
        for (int i1 = 0; i1 < areaHeight; ++i1)
        {
            for (int j1 = 0; j1 < areaWidth; ++j1)
            {
                ...
                {
                    aint1[j1 + i1 * areaWidth] = Biome.getIdForBiome(DarwinsNaturaBiomes.GALAPAGOS);
                }
                else
                {
